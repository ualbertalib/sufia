module Sufia
  module BatchControllerBehavior
    ...
    def update
      ...
      embargo_attributes = OpenStruct.new embargo_release_date: params[:embargo_release_date], visibility_during_embargo: params[:visibility_during_embargo], visibility_after_embargo: params[:visibility_after_embargo]
      Sufia.queue.push(BatchUpdateJob.new(current_user.user_key, params[:id], params[:title], file_attributes, params[:visibility], embargo_attributes))
