module Sufia
  module BatchControllerBehavior
    ...
    def update
      ...
      Sufia.queue.push(BatchUpdateJob.new(current_user.user_key, params[:id], params[:title], file_attributes, params[:visibility], params[:embargo_release_date], params[:visibility_during_embargo], params[:visibility_after_embargo]))
