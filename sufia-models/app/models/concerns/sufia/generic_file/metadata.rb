  ...
  module GenericFile
    module Metadata
      ...
      included do
        ...
        # META: add mediator and source required field
        has_attributes :related_url, :based_near, :part_of, :creator, :source,
                                    :mediator, :coverage, :contributor, :title, :tag, :description, :rights,
